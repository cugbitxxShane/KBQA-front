  ...
  <div class="page-wrapper">
    <el-card class="box-card">
        ...
        <el-breadcrumb separator-class="el-icon-arrow-right">
            ...
            <el-breadcrumb-item>脉内数据样本</el-breadcrumb-item>
        </el-breadcrumb>
        <!-- 搜索 -->
        ...
        <div class="table-wrapper">
          <el-table :data="tableData" height="740" border style="width: 100%">
              ...
              <el-table-column prop="type" label="类型" align="center" width="450"></el-table-column>
              <el-table-column prop="label" label="标签" align="center" width="500"></el-table-column>
              <el-table-column prop="create_time" label="入库时间" align="center"></el-table-column>
          </el-table>
        </div>
        <!-- 分页控件 -->
        <el-pagination
...
export default {
  ...
  methods: {
    ...
    async getTableData () {
      const { data: res } = await this.$http.get('sampleIntraPulseRec', { params: this.queryInfo })
