  ...
  <div class="page-wrapper">
    <el-card class="box-card">
        ...
        <el-breadcrumb separator-class="el-icon-arrow-right">
            ...
            <el-breadcrumb-item>x1工作模式状态识别</el-breadcrumb-item>
        </el-breadcrumb>
        <!-- 搜索 -->
        ...
        <div class="table-wrapper">
          <el-table :data="tableData" height="740" border style="width: 100%">
              <el-table-column prop="id" label="编号" align="center" width="130"></el-table-column>
              <el-table-column prop="state" label="状态" align="center" width="130"></el-table-column>
              <el-table-column prop="toa" label="到达时间" align="center" width="180"></el-table-column>
              <el-table-column prop="pa" label="脉冲幅度" align="center" width="130"></el-table-column>
              <el-table-column prop="pw" label="脉冲宽度" align="center" width="220"></el-table-column>
              <el-table-column prop="doa" label="到达角" align="center" width="130"></el-table-column>
              <el-table-column prop="freq_min" label="最小频率" align="center" width="210"></el-table-column>
              <el-table-column prop="freq_max" label="最大频率" align="center" width="210"></el-table-column>
              <el-table-column prop="mop" label="脉内调制类型" align="center" width="130"></el-table-column>
...
export default {
  ...
  methods: {
    ...
    async getTableData () {
      const { data: res } = await this.$http.get('sampleStsteRecPdwKdjX1', { params: this.queryInfo })
