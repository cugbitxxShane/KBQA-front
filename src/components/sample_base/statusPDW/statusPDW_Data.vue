  ...
  <div class="page-wrapper">
    <el-card class="box-card">
        ...
        <el-breadcrumb separator-class="el-icon-arrow-right">
            ...
            <el-breadcrumb-item>状态PDW_数据表</el-breadcrumb-item>
        </el-breadcrumb>
        <!-- 搜索 -->
...
export default {
  ...
  methods: {
    ...
    async getTableData () {
      const { data: res } = await this.$http.get('statusPDWdata', { params: this.queryInfo })
    ...
    async addItem () {
      const { data: res } = await this.$http.post('estatusPDWdataaddItem', this.addForm)
      console.log(res)
      if (res !== 'success') {
