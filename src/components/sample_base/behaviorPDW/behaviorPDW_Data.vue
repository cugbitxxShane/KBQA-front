  ...
  <div class="page-wrapper">
    <el-card class="box-card">
        ...
        <el-breadcrumb separator-class="el-icon-arrow-right">
            ...
            <el-breadcrumb-item>行为PDW_数据表</el-breadcrumb-item>
        </el-breadcrumb>
        <!-- 搜索 -->
        <el-row class="serachRow">
            <el-col>
                ...
                <el-button icon="el-icon-s-promotion" @click="bolbReadTest()">测试Bolb读取</el-button>
            </el-col>
        </el-row>
        <!-- 表格 -->
...
export default {
  ...
  methods: {
    ...
    async getTableData () {
      const { data: res } = await this.$http.get('behaviorPDWdata', { params: this.queryInfo })
    ...
    async addItem () {
      const { data: res } = await this.$http.post('behaviorPDWdataaddItem', this.addForm)
      console.log(res)
      if (res !== 'success') {
    ...
    // 测试跨域
    async bolbReadTest () {
      const { data: res } = await this.$http.post('bolbReadTest')
      console.log(res)
    }
  }
