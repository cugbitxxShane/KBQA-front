  ...
  <div class="page-wrapper">
    <el-card class="box-card">
        ...
        <el-breadcrumb separator-class="el-icon-arrow-right">
            ...
            <el-breadcrumb-item>雷达总体描述</el-breadcrumb-item>
        </el-breadcrumb>
        <!-- 搜索 -->
        ...
        <div class="table-wrapper">
          <el-table :data="tableData" height="750" border @current-change="handleCurrentRow" style="width: 100%">
              <el-table-column prop="radar_id" label="雷达编号" align="center" width="300"></el-table-column>
              <el-table-column prop="state_num" label="状态数目" align="center" width="300"></el-table-column>
              <el-table-column prop="rf_band" label="载频频带" align="center" width="450"></el-table-column>
              <el-table-column prop="sub_table" label="子表名称" align="center"></el-table-column>
          </el-table>
        </div>
        <!-- 分页控件 -->
        <el-pagination
...
export default {
  ...
  methods: {
    ...
    async getTableData () {
      const { data: res } = await this.$http.get('targetTotal', { params: this.queryInfo })
